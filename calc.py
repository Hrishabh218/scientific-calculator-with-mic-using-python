...
operations={'ADD':add,'ADDITION':add,'SUM':add,'PLUS':add,'SUBSTRACTION':sub,
             'DIFFERENCE':sub, 'MINUS':sub, 'SUBTRACT':sub, 'PRODUCT': mul, 'MULTIPLICATION': mul, 'MULTIPLY': mul, 'DIVISION': div, 'DIV': div, 'DIVIDE': div, 'LCM':lcm, 'HCF':hcf, 'MOD':mod, 'REMAINDER': mod, 'MODULUS': mod }
...
micButton=Button(root,image=micImage,bd=0,bg='dodgerblue3',command='audio')
